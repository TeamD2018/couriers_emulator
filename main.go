...
func init() {
	...
	url = pflag.StringP("url", "u", "0.0.0.0:2018", "url of service emulator")
	...
	ordersPerCourier = pflag.IntP("orders", "o", 3, "number of orders that can be affiliate to one courier")
